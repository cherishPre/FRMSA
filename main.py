...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='MUL_TRANS_NOPO', choices=['MUL_TRANS_NOPO','MUL_TRANS','MUL_TRANS_ONE','MUL_TRANS_TWO','MUL_TRANS_NOCNN','MUL_TRANS_NOTRANS','MUL_TRANS_NOCTC','MUL_TRANS_CROSS'],
    ...
    # "feat_random_drop", "feat_structural_drop","rawa_color_w","rawv_gblur","rawv_impulse_value","rawa_bg_park"
    # parser.add_argument('--augmentation', type=list, default=["feat_random_drop"], 
    #                     help='Selected Noise-based Augmentation Type.')
    parser.add_argument('--dataset', type=str, default='SIMSv2', choices=['MOSI','SIMSv2'],
                        help='Video Understanding Dataset Name.')
    
    parser.add_argument('--train_size', type=int, default=2722,
                        help='.')
    parser.add_argument('--num_workers', type=int, default=0, 
                        help='Number of workers for data loader.')
    parser.add_argument('--eval-noise-type', type=str, default='feat_structural_drop',
                        help='Evaluation Noise Type (validation and test)."feat_random_drop", "feat_structural_drop","rawa_color_w","raw_gblur","raw_color_w","raw_bg_park"')
...
def _run(config):
    ...
    results = trainer.do_robustness_test(model, dataloader['test'])
