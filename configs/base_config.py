...
ALL_MODELS_LITERAL = Literal["T2FN", "MUL_TRANS_NOPO", "MUL_TRANS_CROSS", "MUL_TRANS_NOCTC", "MUL_TRANS_NOTRANS", "MUL_TRANS_NOCNN", "MUL_TRANS_TWO", "MUL_TRANS_ONE","MUL_TRANS"]
...
DATASET_ORI_FEATURE_MAP = {
    ...
    'MOSEI':'MOSEI/Processed/unaligned_v171_a25_l50.pkl',
    'SIMSv2':'SIMSv2/Processed/unaligned_v171_a25_l50.pkl',
    'MIntRec':'MIntRec/Processed/unaligned_v171_a25_l50.pkl'
}
