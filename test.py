...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='T2FN', choices=['T2FN', 'TPFN', 'CTFN', 'MMIN', 'TFRNet', 'GCNET', 'NIAT', 'EMT_DLFR'],
                        help='Robust Baselines Name.')
    parser.add_argument('--augmentation', type=list, default=['rawv_impulse_value'], 
    ...
    parser.add_argument('--eval-noise-type', type=str, default='rawv_impulse_value',
